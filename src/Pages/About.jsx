...
const About = () => {
    return (
        <div className='m-10 flex flex-col gap-8 justify-items-center sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 '>
          <div
...
<div className=' mx-auto flex gap-8 justify-center items-center'>
...
<div className="card mt-12 w-96 bg-base-100 shadow-sm">
...
</div><div className="card mt-12 w-96 bg-base-100 shadow-sm">
